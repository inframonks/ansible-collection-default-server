...
[![Gitea issues](https://img.shields.io/github/issues/OnkelDom/ansible-role-node-exporter?style=flat)](https://gitea.lenhardt.cc/ansible-roles/node-exporter/issues)
[![Gitea tag](https://img.shields.io/github/tag/OnkelDom/ansible-role-node-exporter.svg?style=flat)](https://gitea.lenhardt.cc/ansible-roles/node-exporter/tags)
[![Gitea action](https://github.com/OnkelDom/ansible-role-node-exporter/workflows/ansible-lint/badge.svg)](https://gitea.lenhardt.cc/ansible-roles/node-exporter/actions)
